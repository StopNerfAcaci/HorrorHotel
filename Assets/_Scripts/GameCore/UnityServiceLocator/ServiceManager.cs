...
namespace UnityServiceLocator
{
    public class ServiceManager
    {
        ...
        public T Get<T>() where T : class
        {
            ...
            throw new ArgumentException($"ServiceManager.Get: Service of type {typeof(T).FullName} does not registered.");
        }
        ...
        public ServiceManager Register(Type type, object service)
        {
            ...
            {
                throw new ArgumentException("Service does not match service type.", nameof(service));
            }
